...
def attach_module_video(module_id, module, upload_path="app/course_module_videos"):
...
def seed_courses(courses):
    for course in courses:
        ...
        course_id = resolve_record_id(course, ["document_id", "course_document_id", "id"])
        ...
        for idx, module in enumerate(course["modules"], start=1):
            ...
            if module_id is None:
                ...
                update_entry("course-modules", module_id, {"courses": [course_id]})
